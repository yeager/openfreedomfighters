...
`ZLIST_CutSequenceCommand` has a separate, equally fail-closed observation
boundary in [CUT_SEQUENCE_COMMAND_PHASE_ONE.md](CUT_SEQUENCE_COMMAND_PHASE_ONE.md).

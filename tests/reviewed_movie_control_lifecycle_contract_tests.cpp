...
std::string contract() {
  ...
  const std::string dispatch_bad = R"({"observation_order":0,"phase":"failure","callback_ordinal":7,"movie_component_is_constructed":true,"movie_owner_is_constructed_owner":true,"sequence_component_is_constructed":true,"sequence_owner_is_constructed_owner":true,"movie_phase_one_completed":true,"movie_phase_two_completed":true,"component_status_before":4,"component_status_after":4,"owner_status_before":0,"owner_status_after":0,"event16_gate":"failed","handoff_sender_is_movie_owner":true,"handoff_target_is_sequence_owner":true,"handoff":"failed","delivery_mode":"not_observed","player_activation":"not_started","outcome":"failure","external_service":"entered"})";
